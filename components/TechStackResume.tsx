...
import { Code, ChevronRight, FileDown, Copy, Check } from "lucide-react";
    ...
    >
      <div className="flex items-start space-x-3 sm:space-x-4">
        ...
        <div className="flex-1">
          ...
          >
            No resume? No problem! Enter your tech stack or skills and generate
            a professional resume from scratch with AI-powered content creation.
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-3">
              <motion.button
                ...
                disabled={loading || !!resultText || techStack.length < 50}
                className={`w-full px-6 sm:px-8 py-4 sm:py-3 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center space-x-2 group ${
                  loading || !!resultText || techStack.length < 50
                ...
                whileHover={{
                  scale:
                    loading || !!resultText || techStack.length < 50 ? 1 : 1.05,
                }}
                whileTap={{
                  scale:
                    loading || !!resultText || techStack.length < 50 ? 1 : 0.95,
                }}
              >
                ...
                {loading ? (
                  ...
                  <div className="h-4 w-4 sm:h-5 sm:w-5 text-emerald-200">
                    ✓
                  </div>
                ) : (
