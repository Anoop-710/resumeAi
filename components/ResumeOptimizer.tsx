    ...
    >
      <div className="flex items-start space-x-3 sm:space-x-4">
        ...
        <div className="flex-1">
          ...
          >
            Upload your resume (PDF/DOCX or text) and get a polished,
            professional version with improved formatting and content
            optimization. NOTE: This option uses free AI service, which might
            use your data for training purposes. Avoid including sensitive
            ...
            {useFileUpload ? (
              <div>
                ...
                <div className="relative">
                  ...
                  <label
                    ...
                    className={`flex items-center justify-center w-full px-6 py-4 border-2 border-dashed ${
                      darkMode
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-300 resize-none ${
                    darkMode
            ...
            <div className="flex flex-col gap-3">
              <motion.button
                ...
                disabled={
                  loading ||
                  !!resultText ||
                  (useFileUpload ? !files.resume : !resumeText.trim())
                }
